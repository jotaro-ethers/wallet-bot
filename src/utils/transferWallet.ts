...
const rpc: string = "https://rpc.testnet.tomochain.com";
// const rpc: string = "https://rpc.sepolia.org	";
...
class TransferWalletUtil {
  ...
  async sendTokenNative(
    ...
    // find user to get privateKey
    const privateKey: string = "";
    // const privateKey = userModel.aggregate([
    //   { $unwind: "$wallets" },
  ...
  async sendNft(
    ...
    const tx = await contractToken.safeTransferFrom(fromAddr, toAddr, tokenId);
    console.log("TRANSACTION: ", tx);
...
function main() {
  const transferWallet = new TransferWalletUtil();
  // transferWallet.sendToken(
  //   "0xb12B2Ff5677337445D6A62d6acC40Ff667305165",
  //   "0x1627d17DaD1f89E6bA5B839488a66C731e6cb8e8",
  //   "0x5c07057541FB35AA2E8c0e0e2aab0FA344c73974",
  //   // "0xA7bc4d3754eeb83A5f8000A99593aC82A6E29002",
  //   "10"
  // );
  transferWallet.sendNft(
    "0xb12B2Ff5677337445D6A62d6acC40Ff667305165",
    "0x1627d17DaD1f89E6bA5B839488a66C731e6cb8e8",
    "0xd338da769B7eC5b39091f8C5D267c90575581552",
    "0"
  );
}
